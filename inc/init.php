...
?>
	<div class="no-container post_type_my_post_lastest" style="position: relative; ">
		<div class="row">
			<div class="col s12">
	<?php
				// The Loop
				if ( $the_query->have_posts() ) {
					echo '<ul class="list-my_post" id="list-my_post-ID">';
					while ( $the_query->have_posts() ) {
						$the_query->the_post();
						echo '<li class="col s12 m6 l4 item-post" style="">';
