...
<div class="bg-header" style="height: 100px; width: 100%; background-color: #FFFFFF; z-index: 12;">
    ...
    <div class="container" style="height: 100%; z-index: 11;" id="logo-and-nav">
        ...
        <div class="row" id="header-menu" style="height: 100%; ">
            ...
            <div class="col s12 l3" id="lines-button" style="z-index: 11;" onclick="showMenu();">
